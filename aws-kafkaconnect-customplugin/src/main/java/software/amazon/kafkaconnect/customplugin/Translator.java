...
public class Translator {
    ...
    private static CustomPluginFileDescription sdkCustomPluginFileDescriptionToResourceCustomPluginFileDescription(
    ...
    private static CustomPluginLocation sdkCustomPluginLocationDescriptionToResourceCustomPluginLocation(
    ...
    private static S3Location sdkS3LocationDescriptionToResourceS3Location(
    ...
    private static software.amazon.awssdk.services.kafkaconnect.model.CustomPluginLocation resourceCustomPluginLocationToSdkCustomPluginLocation(
    ...
    private static software.amazon.awssdk.services.kafkaconnect.model.S3Location resourceS3LocationToSdkS3Location(
