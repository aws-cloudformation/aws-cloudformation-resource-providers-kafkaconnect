...
public class AbstractTestBase {
    ...
    static ProxyClient<KafkaConnectClient> proxyStub(
        ...
        return new ProxyClient<KafkaConnectClient>() {
            ...
            injectCredentialsAndInvokeV2Async(RequestT request, Function<RequestT, CompletableFuture<ResponseT>>
                requestFunction) {
            ...
            injectCredentialsAndInvokeV2InputStream(RequestT requestT, Function<RequestT,
            ...
            injectCredentialsAndInvokeV2Bytes(RequestT requestT, Function<RequestT,
                ResponseBytes<ResponseT>> function) {
